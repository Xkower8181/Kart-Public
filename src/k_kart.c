...
const UINT8 KartColor_Opposite[MAXSKINCOLORS*2] =
{
	...
	SKINCOLOR_HANDHELD,10,    // SKINCOLOR_CHERRY
        SKINCOLOR_ASHURA,8,       // SKINCOLOR_MERIDAN
	...
	SKINCOLOR_RED,8,          // SKINCOLOR_GREEN
        SKINCOLOR_FAIRY,4,        // SKINCOLOR_ASHURA
	...
	SKINCOLOR_LEMONADE,8,     // SKINCOLOR_THUNDER
        SKINCOLOR_WHITE,16,       // SKINCOLOR_GOTHIC
	...
	SKINCOLOR_PUMPKIN,8,      // SKINCOLOR_BLUEBERRY
        ...
        SKINCOLOR_BLACK,8,        // SKINCOLOR_BISMUTH
...
UINT8 colortranslations[MAXTRANSLATIONS][16] = {
	...
	{  4,   7,  11,  15,  20,  22,  24,  27,  28,  28,  28,  29,  29,  30,  30,  31}, // SKINCOLOR_BLACK
        {120,   5,  10,  15,  20,  25,  26,  27,  28,  31,  31,  31,  31,  31,  31,  31}, // SKINCOLOR_INKBLOT
	{ 15,  19,  21,  23,  24,  25,  26,  27,  28,  28,  29,  29,  30,  30,  31,  31}, // SKINCOLOR_CHARCOAL
        ...
        { 10,  12,  40,  43,  45, 156, 157, 159,  25,  27,  28,  29,  30,  30,  31,  31}, // SKINCOLOR_DOOM
	...
	{  0,   1,   3,   5,   7,   9,  34,  36,  38,  40,  42,  44,  60,  61,  62,  63}, // SKINCOLOR_SEPIA
        {120,  80,  81,  68,  73,  32,  34,  36,  38,  40,  19,  21,  23,  27,  29,  31}, // SKINCOLOR_IVORY
	...
	{  3,   6,  32,  33,  35,  37,  51,  52,  54,  55,  57,  58,  60,  61,  63,  30}, // SKINCOLOR_WALNUT
        {  3,   6,   8,  10,  36,  37,  38,  52,  53,  55,  57,  60,  62,  63,  29,  31}, // SKINCOLOR_FOUNDATION
        ...
        {120,  96,  97,  98,  67,  83,  84,  77,  78, 153, 154, 155, 156, 157, 158, 159}, // SKINCOLOR_SUNTAN
	...
	{ 68,  75,  48,  50,  52,  94, 152, 136, 137, 138, 139, 140, 141, 142, 143,  31}, // SKINCOLOR_CINNAMON
        {120, 122, 124, 126, 128, 129, 130,  94,  95, 198, 199, 199, 255, 255,  30,  31}, // SKINCOLOR_HALLOWEEN
	...
	{120, 121, 122, 123, 124, 125, 126, 127, 128, 130, 131, 134, 136, 137, 139, 140}, // SKINCOLOR_RASPBERRY
        {  0, 176, 177, 113, 124, 125, 126, 127, 127, 129, 130, 132, 136, 139, 141, 143}, // SKINCOLOR_STRAWBERRY
	...
	{123, 125, 128, 131, 133, 135, 136, 138, 140, 140, 141, 141, 142, 142, 143,  31}, // SKINCOLOR_CRIMSON
        {122, 192, 193, 194, 195, 196, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143}, // SKINCOLOR_DISCO
	...
	{120, 121, 122, 123, 124, 147, 148,  91,  93,  95, 152, 154, 156, 159, 141, 143}, // SKINCOLOR_DAWN
        ...
        {120, 208, 213, 220, 179, 115,  89,  91,  92,  93,  95, 119, 138, 140, 142, 143}, // SKINCOLOR_MIAMI
	...
	{ 82,  83,  84,  85,  87,  89,  90,  92,  94, 152, 153, 155, 157, 159, 141, 142}, // SKINCOLOR_PUMPKIN
        {120,  80,  81,  82,  83,  84,  85,  94,  95, 156, 157, 158, 158, 159, 141, 143}, // SKINCOLOR_AMBER
	...
	{ 98, 101, 104, 105, 106, 115, 107, 108, 182, 109, 183, 110, 174, 111,  30,  31}, // SKINCOLOR_OLIVE
        ...
        {113, 114,  36,  16,  18,  20,  21, 109, 110,  63,  27,  28,  28,  29,  30,  31}, // SKINCOLOR_MOSHPIT
	...
	{120, 176, 160, 165, 167, 168, 169, 182, 182, 171,  60,  61,  63,  29,  30,  31}, // SKINCOLOR_ROBOHOOD
        ...
        {120, 120,   0,   0,  96,  97, 176, 177, 178, 165, 167, 221, 222, 223, 174, 143}, // SKINCOLOR_PEPPERMINT
	...
	{  2,   4,   6,   8,  10,  12,  13, 167, 168, 169, 170, 171, 172, 173, 174, 175}, // SKINCOLOR_ASHURA
	...
	{160, 184, 184, 185, 185, 186, 186, 187, 187, 188, 188, 189, 189, 190, 191, 175}, // SKINCOLOR_SHAMROCK
        ...
        {160, 160, 184, 185, 185, 186, 180, 251, 196, 197, 197, 198, 198, 199, 199, 255}, // SKINCOLOR_PUNK
	...
	{208, 209, 210, 211, 213, 220, 216, 167, 168, 188, 188, 189, 190, 191,  30,  31}, // SKINCOLOR_ALGAE
        ...
        {120, 208, 209, 210, 211, 212, 185, 186, 187, 188, 221, 222, 240, 242, 244, 246}, // SKINCOLOR_MASTER
	...
	{210, 213, 220, 220, 220, 216, 216, 221, 221, 221, 222, 222, 223, 223, 191,  31}, // SKINCOLOR_TEAL
        ...
        {120,  96,  97,  98, 176, 177, 178, 221, 222, 253, 253, 254, 254, 255, 143,  31}, // SKINCOLOR_FIREFLY
	...
	{ 96,  97,  98, 112, 113, 114,  11, 203, 204, 205, 205, 237, 239, 241, 243, 246}, // SKINCOLOR_THUNDER
        {208, 210, 226, 249, 131, 134, 253, 206, 207, 255,  28,  28,  29,  29,  30,  31}, // SKINCOLOR_GOTHIC
	...
	{226, 228, 229, 230, 232, 233, 235, 237, 239, 240, 242, 244, 246,  31,  31,  31}, // SKINCOLOR_BLUEBERRY
        ...
        {120, 120,  80, 100, 112, 178, 179, 203, 251, 252, 138, 159, 110, 174, 245, 246}, // SKINCOLOR_BISMUTH
	...
	{120, 122, 124, 125, 126, 150, 196, 197, 198, 198, 199, 199, 240, 242, 244, 246}, // SKINCOLOR_FUCHSIA
        {120, 122, 124, 126, 127, 128, 128, 196, 196, 197, 197, 198, 199, 141, 142, 143}, // SKINCOLOR_MULBERRY
        {123, 125, 130, 132, 133, 197, 197, 198, 198, 199, 199, 141, 141, 142, 142, 143}, // SKINCOLOR_BOYSENBERRY
        {120, 122, 124, 126, 130, 196, 252, 253, 253, 254, 254, 255, 255,  28,  29,  31}, // SKINCOLOR_SPIDER
